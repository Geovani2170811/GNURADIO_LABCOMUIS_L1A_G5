...
class PruebaPAM_2170811(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "PruebaPAM_2170811", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("PruebaPAM_2170811")
        ...
        self.settings = Qt.QSettings("GNU Radio", "PruebaPAM_2170811")
        ...
        self._Am_range = Range(0, 100, 100e-3, 1, 200)
...
def main(top_block_cls=PruebaPAM_2170811, options=None):
