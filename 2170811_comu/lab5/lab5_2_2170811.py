...
class lab5_2_2170811(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab5_2_2170811")
        ...
        self.modulaciondepulsos_0_0_2 = modulaciondepulsos(
            d=D,
            fs=fs,
            samp_rate=samp_rate,
        )
        self.modulaciondepulsos_0_0_1 = modulaciondepulsos(
            d=D,
            fs=fs,
            samp_rate=samp_rate,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.analog_sig_source_x_0, 0), (self.modulaciondepulsos_0_0_0, 0))
        self.connect((self.analog_sig_source_x_0_0, 0), (self.modulaciondepulsos_0_0, 0))
        self.connect((self.analog_sig_source_x_0_1, 0), (self.modulaciondepulsos_0_0_1, 0))
        self.connect((self.analog_sig_source_x_0_2, 0), (self.modulaciondepulsos_0_0_2, 0))
        ...
        self.connect((self.modulaciondepulsos_0_0_0, 0), (self.blocks_add_xx_0, 0))
        self.connect((self.modulaciondepulsos_0_0_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.modulaciondepulsos_0_0_1, 0), (self.blocks_delay_0_0, 0))
        self.connect((self.modulaciondepulsos_0_0_2, 0), (self.blocks_delay_0_1, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.modulaciondepulsos_0_0_1.set_samp_rate(self.samp_rate)
        self.modulaciondepulsos_0_0_2.set_samp_rate(self.samp_rate)
    ...
    def set_fs(self, fs):
        ...
        self.modulaciondepulsos_0_0_1.set_fs(self.fs)
        self.modulaciondepulsos_0_0_2.set_fs(self.fs)
    ...
    def set_D(self, D):
        ...
        self.modulaciondepulsos_0_0_1.set_d(self.D)
        self.modulaciondepulsos_0_0_2.set_d(self.D)
...
def main(top_block_cls=lab5_2_2170811, options=None):
