...
class practica2_3(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "pct2_3", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("pct2_3")
        ...
        self.settings = Qt.QSettings("GNU Radio", "practica2_3")
...
def main(top_block_cls=practica2_3, options=None):
