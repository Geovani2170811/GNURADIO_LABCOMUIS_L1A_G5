...
from EnvolventeComplejaPM_2170811 import EnvolventeComplejaPM_2170811  # grc-generated hier_block
...
class Lab4_1_2170811(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.EnvolventeComplejaPM_2170811_0 = EnvolventeComplejaPM_2170811(
            Ac=100e-3,
            kp=1,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.EnvolventeComplejaPM_2170811_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.EnvolventeComplejaPM_2170811_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.EnvolventeComplejaPM_2170811_0, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.EnvolventeComplejaPM_2170811_0, 0))
