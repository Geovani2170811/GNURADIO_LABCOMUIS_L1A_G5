...
class demux_FM_2170811(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Demodulador FM 2170811", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Demodulador FM 2170811")
        ...
        self.settings = Qt.QSettings("GNU Radio", "demux_FM_2170811")
        ...
        self.analog_fm_preemph_0 = analog.fm_preemph(fs=int(samp_rate/(2*D)), tau=75e-6, fh=-1.0)
...
def main(top_block_cls=demux_FM_2170811, options=None):
